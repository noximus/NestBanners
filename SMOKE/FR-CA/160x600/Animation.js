home_animation = (function() {
	...
	function frame1()
	{
		TweenLite.to(first_text, 2, {opacity:0, top:-300, delay: 3});
		TweenLite.to(product_text, 1, {top:-60, scaleX:.72, scaleY:.72, delay:3});
		TweenLite.to(bg, 1, {top:-110, scaleX:1, scaleY:1, delay:3});
