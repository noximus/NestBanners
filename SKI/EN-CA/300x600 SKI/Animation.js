home_animation = (function() {
	...
	function frame1()
	{
		...
		TweenLite.to(product_text, 1, {top:-170, scaleX:1, scaleY:1, delay:2});		
		TweenLite.to(bg, 1, {top:-175, scaleX:1, scaleY:1, delay:2});
		TweenLite.to(bgMask2, .9, {top:0, opacity:1, delay:2});
